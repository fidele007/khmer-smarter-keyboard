...
@interface com_vanna_KhmerKeyboard_Keyboard.TrigramPrediction : NSOperation {
...
@property (copy,nonatomic) NSString * gram2; 
...
-(NSString *)gram2;
-(void)setGram2:(NSString *)arg1 ;
-(id)initWithGram1:(id)arg1 gram2:(id)arg2 db:(id)arg3 userDB:(id)arg4 ;
-(id)init;
-(void)main;
