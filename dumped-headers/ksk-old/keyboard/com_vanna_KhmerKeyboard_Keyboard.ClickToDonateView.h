...
@interface com_vanna_KhmerKeyboard_Keyboard.ClickToDonateView : UIButton {

	 secondaryTitle;

}

@property (retain,nonatomic) UILabel * secondaryTitle; 
...
-(void)setSecondaryTitle:(UILabel *)arg1 ;
@end
